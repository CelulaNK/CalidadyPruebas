...
namespace TrabajoFinalWeb.Controllers
{
    ...
    public class ProductoesController : Controller
    {
        ...
        {
            ViewBag.IdTipoProducto = new SelectList(db.TipoProductoes, "ID", "Descripcion");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "ID,Nombre,IdTipoProducto,Precio,Descripcion,imagen,Stock")] Producto producto)
        {
            ...
            ViewBag.IdTipoProducto = new SelectList(db.TipoProductoes, "ID", "Descripcion", producto.IdTipoProducto);
            return View(producto);
        }
